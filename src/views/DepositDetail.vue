  ...
  <div class="deposit-detail">
    ...
    <div class="content">
      ...
      <div class="instructions-section">
        ...
        <div class="instruction-item">请在发起转账前确认网络和地址。</div>
        <div class="instruction-item last-item">
          通过其他网络进行的存款将无法到账,并且可能导致资金永久丢失。
        </div>
        <div class="instruction-item last-item">
          入金顯示資金「已提交」後,依不同儲值方式,後台處理儲值所需的時間也不同,實際收款以Web3
          交易商收款顯示為準。
        </div>
        <div class="instruction-item">
          資金到達 Web3
          帳戶後需要進行資金認證批准。美國假日不處理審核流程,請預留存款處理時間。據悉大陸地區無法進行出入金操作,感謝您對
          Web3 的支持!
        </div>
      </div>
    </div>
