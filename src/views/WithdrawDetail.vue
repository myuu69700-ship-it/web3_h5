  ...
  <div class="withdraw-detail">
      ...
      <div class="fee-section">
        <div class="fee-info">
          ...
          <span class="fee-value"
            >{{ withdrawalFee }}{{ selectedCoin.symbol }}</span
          >
          <span class="estimated-amount">預計到帳 {{ estimatedAmount }}</span>
        </div>
      </div>
    ...
    >
      <div class="picker-popup">
        ...
        <div class="picker-header">
          <span class="picker-cancel" @click="showCoinPicker = false"
            >取消</span
          >
    ...
    >
      <div class="picker-popup">
        <div class="drag-handle"></div>
        <div class="picker-header">
          <span class="picker-cancel" @click="showChainPicker = false"
            >取消</span
          >
          <span class="picker-confirm" @click="confirmChainSelection"
            >確認</span
          >
        </div>
        <div class="picker-content">
