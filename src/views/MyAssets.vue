<template>
  <div class="my-assets">
    <van-nav-bar title="我的资产" fixed placeholder left-arrow @click-left="goBack" />
    ...
    <div class="content">
      ...
      <div class="asset-summary">
        <div class="summary-header">
          ...
          <van-icon name="eye-o" class="eye-icon" @click="toggleBalanceVisibility" />
        </div>
        <div class="total-balance">
          <span v-if="balanceVisible">{{ totalBalance }} USD</span>
          <span v-else class="masked">*******.** USD</span>
        </div>
        <div class="daily-profit">
          <span>今日收益</span>
          <span :class="dailyProfit >= 0 ? 'profit' : 'loss'">
            <span v-if="balanceVisible">{{ dailyProfit >= 0 ? '+' : '' }}{{ dailyProfit }} ({{ dailyProfitPercent }}%)</span>
      ...
      <div class="action-buttons">
        ...
        <div class="action-btn" @click="handleWithdraw">
          <div class="btn-icon withdraw-icon">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 19V5M12 19L6 13M12 19L18 13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
        ...
        <div class="action-btn" @click="handleTransfer">
          <div class="btn-icon transfer-icon">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 7H16M8 7L5 4M8 7L5 10M16 17H8M16 17L19 20M16 17L19 14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          ...
          <div class="distribution-card">
            <div class="card-icon spot-icon">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M7 10H17M7 14H12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
        ...
        <div class="asset-list">
          ...
          >
            <div class="asset-left">
              <div class="asset-icon" :style="{ backgroundColor: asset.iconBg }">
...
// 资产列表
const assets = ref([
  { symbol: 'GRT', quantity: '0', value: '0.00', profit: '0.00', iconBg: '#6746ED', iconText: 'G' },
  { symbol: 'HBAR', quantity: '0', value: '0.00', profit: '0.00', iconBg: '#000000', iconText: 'H' },
  { symbol: 'ARB', quantity: '0', value: '0.00', profit: '0.00', iconBg: '#2D374B', iconText: 'A' },
  { symbol: 'TUSD', quantity: '0', value: '0.00', profit: '0.00', iconBg: '#002868', iconText: 'T' },
  { symbol: 'ETC', quantity: '0', value: '0.00', profit: '0.00', iconBg: '#00A859', iconText: 'E' },
  { symbol: 'IMX', quantity: '0', value: '0.00', profit: '0.00', iconBg: '#000000', iconText: 'X' }
])
